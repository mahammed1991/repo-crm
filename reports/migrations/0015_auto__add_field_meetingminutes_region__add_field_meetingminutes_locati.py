...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.region'
        db.add_column(u'reports_meetingminutes', 'region',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.location'
        db.add_column(u'reports_meetingminutes', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.program'
        db.add_column(u'reports_meetingminutes', 'program',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.program_type'
        db.add_column(u'reports_meetingminutes', 'program_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


        # Changing field 'MeetingMinutes.tenantive_agenda'
        db.alter_column(u'reports_meetingminutes', 'tenantive_agenda', self.gf('jsonfield2.fields.JSONField')())

    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.region'
        db.delete_column(u'reports_meetingminutes', 'region')

        # Deleting field 'MeetingMinutes.location'
        db.delete_column(u'reports_meetingminutes', 'location')

        # Deleting field 'MeetingMinutes.program'
        db.delete_column(u'reports_meetingminutes', 'program')

        # Deleting field 'MeetingMinutes.program_type'
        db.delete_column(u'reports_meetingminutes', 'program_type')


        # Changing field 'MeetingMinutes.tenantive_agenda'
        db.alter_column(u'reports_meetingminutes', 'tenantive_agenda', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
