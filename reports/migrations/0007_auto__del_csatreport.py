...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('reports_csatreport')


    def backwards(self, orm):
        # Adding model 'CSATReport'
        db.create_table('reports_csatreport', (
            ...
            ('cli', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
            ...
            ('sf_lead_id', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
            ('survey_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('customer_id', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
