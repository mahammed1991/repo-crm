...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSATReport.mapped_lead_created_date'
        db.add_column(u'reports_csatreport', 'mapped_lead_created_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSATReport.mapped_lead_created_date'
        db.delete_column(u'reports_csatreport', 'mapped_lead_created_date')
