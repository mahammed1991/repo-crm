...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_csatreport', (
            ...
            ('language', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('customer_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('cli', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ...
            ('survey_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
