...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_meetingminutes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject_timeline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ...
        db.send_create_signal(u'reports', ['MeetingMinutes'])

        # Adding M2M table for field attendees on 'MeetingMinutes'
        m2m_table_name = db.shorten_name(u'reports_meetingminutes_attendees')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'reports_meetingminutes')
