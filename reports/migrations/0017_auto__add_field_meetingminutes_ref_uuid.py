...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.ref_uuid'
        db.add_column(u'reports_meetingminutes', 'ref_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.ref_uuid'
        db.delete_column(u'reports_meetingminutes', 'ref_uuid')
