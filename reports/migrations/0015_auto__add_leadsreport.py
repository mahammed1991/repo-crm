...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadsReport'
        db.create_table(u'reports_leadsreport', (
            ...
            ('lead_owner_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('lead_owner_email', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('lead_sub_status', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('code_type', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('program', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('tat', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('date_of_installation', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 1, 28, 0, 0))),
            ('updated_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 1, 28, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'reports', ['LeadsReport'])


    def backwards(self, orm):
        # Deleting model 'LeadsReport'
        db.delete_table(u'reports_leadsreport')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
