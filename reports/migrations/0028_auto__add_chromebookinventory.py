...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChromebookInventory'
        db.create_table(u'reports_chromebookinventory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('employee_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('employee_ldap', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('employee_alias', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('employee_project', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('device_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('mac_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('employee_status', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('device_status', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('issued_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('returned_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='modified_by', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'reports', ['ChromebookInventory'])


    def backwards(self, orm):
        # Deleting model 'ChromebookInventory'
        db.delete_table(u'reports_chromebookinventory')
    ...
    models = {
        ...
        u'reports.chromebookinventory': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'device_status': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'employee_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 12, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
