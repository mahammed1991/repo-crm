...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RLSABulkUpload.upload_id'
        db.add_column(u'reports_rlsabulkupload', 'upload_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RLSABulkUpload.upload_id'
        db.delete_column(u'reports_rlsabulkupload', 'upload_id')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 16, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
