...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSATReport.region'
        db.add_column(u'reports_csatreport', 'region',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'CSATReport.lead_owner'
        db.add_column(u'reports_csatreport', 'lead_owner',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'CSATReport.code_type'
        db.add_column(u'reports_csatreport', 'code_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'CSATReport.program'
        db.add_column(u'reports_csatreport', 'program',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSATReport.region'
        db.delete_column(u'reports_csatreport', 'region')

        # Deleting field 'CSATReport.lead_owner'
        db.delete_column(u'reports_csatreport', 'lead_owner')

        # Deleting field 'CSATReport.code_type'
        db.delete_column(u'reports_csatreport', 'code_type')

        # Deleting field 'CSATReport.program'
        db.delete_column(u'reports_csatreport', 'program')
    ...
    models = {
        ...
        u'reports.csatreport': {
            ...
            'code_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'lead_owner': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'process': ('django.db.models.fields.CharField', [], {'default': "'TAG'", 'max_length': '10'}),
            'program': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100'}),
