...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KickOffProgram.program_created_by'
        db.add_column(u'reports_kickoffprogram', 'program_created_by',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KickOffProgram.program_created_by'
        db.delete_column(u'reports_kickoffprogram', 'program_created_by')
