...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChromebookInventory.device_status'
        db.alter_column(u'reports_chromebookinventory', 'device_status', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ChromebookInventory.device_status'
        db.alter_column(u'reports_chromebookinventory', 'device_status', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 24, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
