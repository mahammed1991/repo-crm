...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CSATFilterDetails.language_category'
        db.alter_column(u'reports_csatfilterdetails', 'language_category', self.gf('django.db.models.fields.CharField')(max_length=11))

    def backwards(self, orm):

        # Changing field 'CSATFilterDetails.language_category'
        db.alter_column(u'reports_csatfilterdetails', 'language_category', self.gf('django.db.models.fields.CharField')(max_length=10))
