...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.link_file_name'
        db.add_column(u'reports_meetingminutes', 'link_file_name',
                      self.gf('jsonfield2.fields.JSONField')(default={}),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attach_file_name'
        db.add_column(u'reports_meetingminutes', 'attach_file_name',
                      self.gf('jsonfield2.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.link_file_name'
        db.delete_column(u'reports_meetingminutes', 'link_file_name')

        # Deleting field 'MeetingMinutes.attach_file_name'
        db.delete_column(u'reports_meetingminutes', 'attach_file_name')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 2, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'reports.meetingminutes': {
            ...
            'attach_file_name': ('jsonfield2.fields.JSONField', [], {'default': '{}'}),
            ...
            'link_file_name': ('jsonfield2.fields.JSONField', [], {'default': '{}'}),
