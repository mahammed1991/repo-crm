...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CallLogAccountManager.sheet_row_count'
        db.add_column('call_log_account_manager', 'sheet_row_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CallLogAccountManager.sheet_row_count'
        db.delete_column('call_log_account_manager', 'sheet_row_count')
