...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RLSABulkUpload'
        db.create_table(u'reports_rlsabulkupload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('file_path', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('original_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('uploaded_leads', self.gf('django.db.models.fields.IntegerField')()),
            ('total_leads', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'reports', ['RLSABulkUpload'])


    def backwards(self, orm):
        # Deleting model 'RLSABulkUpload'
        db.delete_table(u'reports_rlsabulkupload')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
