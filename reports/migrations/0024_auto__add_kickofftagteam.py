...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KickoffTagteam'
        db.create_table(u'reports_kickofftagteam', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kickoff_program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.KickOffProgram'])),
            ('primery_poc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('secondary_poc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('qa', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('qc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('trainer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('all_reps', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('kickoff_meeting_date_time', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('training_start_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('training_end_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('golive_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('tagteam_added_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'reports', ['KickoffTagteam'])


    def backwards(self, orm):
        # Deleting model 'KickoffTagteam'
        db.delete_table(u'reports_kickofftagteam')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 10, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
