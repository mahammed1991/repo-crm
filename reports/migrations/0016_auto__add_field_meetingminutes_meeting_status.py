...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.meeting_status'
        db.add_column(u'reports_meetingminutes', 'meeting_status',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.meeting_status'
        db.delete_column(u'reports_meetingminutes', 'meeting_status')
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 1, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
