...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingMinutes.attachment_1'
        db.add_column(u'reports_meetingminutes', 'attachment_1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attachment_2'
        db.add_column(u'reports_meetingminutes', 'attachment_2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attachment_3'
        db.add_column(u'reports_meetingminutes', 'attachment_3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attachment_4'
        db.add_column(u'reports_meetingminutes', 'attachment_4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attachment_5'
        db.add_column(u'reports_meetingminutes', 'attachment_5',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attached_link_1'
        db.add_column(u'reports_meetingminutes', 'attached_link_1',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attached_link_2'
        db.add_column(u'reports_meetingminutes', 'attached_link_2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attached_link_3'
        db.add_column(u'reports_meetingminutes', 'attached_link_3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attached_link_4'
        db.add_column(u'reports_meetingminutes', 'attached_link_4',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MeetingMinutes.attached_link_5'
        db.add_column(u'reports_meetingminutes', 'attached_link_5',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingMinutes.attachment_1'
        db.delete_column(u'reports_meetingminutes', 'attachment_1')

        # Deleting field 'MeetingMinutes.attachment_2'
        db.delete_column(u'reports_meetingminutes', 'attachment_2')

        # Deleting field 'MeetingMinutes.attachment_3'
        db.delete_column(u'reports_meetingminutes', 'attachment_3')

        # Deleting field 'MeetingMinutes.attachment_4'
        db.delete_column(u'reports_meetingminutes', 'attachment_4')

        # Deleting field 'MeetingMinutes.attachment_5'
        db.delete_column(u'reports_meetingminutes', 'attachment_5')

        # Deleting field 'MeetingMinutes.attached_link_1'
        db.delete_column(u'reports_meetingminutes', 'attached_link_1')

        # Deleting field 'MeetingMinutes.attached_link_2'
        db.delete_column(u'reports_meetingminutes', 'attached_link_2')

        # Deleting field 'MeetingMinutes.attached_link_3'
        db.delete_column(u'reports_meetingminutes', 'attached_link_3')

        # Deleting field 'MeetingMinutes.attached_link_4'
        db.delete_column(u'reports_meetingminutes', 'attached_link_4')

        # Deleting field 'MeetingMinutes.attached_link_5'
        db.delete_column(u'reports_meetingminutes', 'attached_link_5')
