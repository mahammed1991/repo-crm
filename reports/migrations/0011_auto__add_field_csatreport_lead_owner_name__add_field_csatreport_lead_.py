...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CSATReport.lead_owner_name'
        db.add_column(u'reports_csatreport', 'lead_owner_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'CSATReport.lead_owner_email'
        db.add_column(u'reports_csatreport', 'lead_owner_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CSATReport.lead_owner_name'
        db.delete_column(u'reports_csatreport', 'lead_owner_name')

        # Deleting field 'CSATReport.lead_owner_email'
        db.delete_column(u'reports_csatreport', 'lead_owner_email')
