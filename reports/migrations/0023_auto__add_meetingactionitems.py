...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeetingActionItems'
        db.create_table(u'reports_meetingactionitems', (
            ...
            ('closed_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('reopened_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('resolved_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'reports', ['MeetingActionItems'])


    def backwards(self, orm):
        # Deleting model 'MeetingActionItems'
        db.delete_table(u'reports_meetingactionitems')
