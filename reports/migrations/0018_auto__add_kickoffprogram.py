...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KickOffProgram'
        db.create_table(u'reports_kickoffprogram', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('program_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('google_poc_locations', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('advertiser_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('codetypeslist', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('programe_start_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('programe_end_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('estimated_lead_volume', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('program_overview_objective', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('succes_matrix', self.gf('jsonfield2.fields.JSONField')(default={}, blank=True)),
            ('expectations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('explain_workflow', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('win_criteria', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('lead_sub_mode', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('lead_subbmission_other_val', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('real_time_support_chat', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('real_time_support_live_trans', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('tag_team_connect_detail', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('file_url_name', self.gf('jsonfield2.fields.JSONField')(default={}, blank=True)),
            ('attached_url_link_1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('attached_url_link_2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('attached_url_link_3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('attached_url_link_4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('attached_url_link_5', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('file_upload_name', self.gf('jsonfield2.fields.JSONField')(default={}, blank=True)),
            ('upload_file_attachment_1', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('upload_file_attachment_2', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('upload_file_attachment_3', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('upload_file_attachment_4', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('upload_file_attachment_5', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'reports', ['KickOffProgram'])

        # Adding M2M table for field google_poc on 'KickOffProgram'
        m2m_table_name = db.shorten_name(u'reports_kickoffprogram_google_poc')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('kickoffprogram', models.ForeignKey(orm[u'reports.kickoffprogram'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['kickoffprogram_id', 'user_id'])

        # Adding M2M table for field google_poc_email on 'KickOffProgram'
        m2m_table_name = db.shorten_name(u'reports_kickoffprogram_google_poc_email')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('kickoffprogram', models.ForeignKey(orm[u'reports.kickoffprogram'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ...
        # Adding M2M table for field region on 'KickOffProgram'
        m2m_table_name = db.shorten_name(u'reports_kickoffprogram_region')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('kickoffprogram', models.ForeignKey(orm[u'reports.kickoffprogram'], null=False)),
            ('region', models.ForeignKey(orm[u'reports.region'], null=False))
        ))
        db.create_unique(m2m_table_name, ['kickoffprogram_id', 'region_id'])

        # Adding M2M table for field target_locations on 'KickOffProgram'
        m2m_table_name = db.shorten_name(u'reports_kickoffprogram_target_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('kickoffprogram', models.ForeignKey(orm[u'reports.kickoffprogram'], null=False)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['kickoffprogram_id', 'location_id'])


    def backwards(self, orm):
        # Deleting model 'KickOffProgram'
        db.delete_table(u'reports_kickoffprogram')

        # Removing M2M table for field google_poc on 'KickOffProgram'
        db.delete_table(db.shorten_name(u'reports_kickoffprogram_google_poc'))

        # Removing M2M table for field google_poc_email on 'KickOffProgram'
        db.delete_table(db.shorten_name(u'reports_kickoffprogram_google_poc_email'))

        # Removing M2M table for field region on 'KickOffProgram'
        db.delete_table(db.shorten_name(u'reports_kickoffprogram_region'))

        # Removing M2M table for field target_locations on 'KickOffProgram'
        db.delete_table(db.shorten_name(u'reports_kickoffprogram_target_locations'))
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 4, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
