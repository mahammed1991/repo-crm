...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field bcc_kick_off on 'KickOffProgram'
        m2m_table_name = db.shorten_name(u'reports_kickoffprogram_bcc_kick_off')
        ...
        # Adding M2M table for field bcc_tagteam on 'KickoffTagteam'
        m2m_table_name = db.shorten_name(u'reports_kickofftagteam_bcc_tagteam')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('kickofftagteam', models.ForeignKey(orm[u'reports.kickofftagteam'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['kickofftagteam_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field bcc_kick_off on 'KickOffProgram'
        db.delete_table(db.shorten_name(u'reports_kickoffprogram_bcc_kick_off'))

        # Removing M2M table for field bcc_tagteam on 'KickoffTagteam'
        db.delete_table(db.shorten_name(u'reports_kickofftagteam_bcc_tagteam'))
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 16, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
