...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChromebookInventory.employee_id'
        db.delete_column(u'reports_chromebookinventory', 'employee_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ChromebookInventory.employee_id'
        raise RuntimeError("Cannot reverse this migration. 'ChromebookInventory.employee_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ChromebookInventory.employee_id'
        db.add_column(u'reports_chromebookinventory', 'employee_id',
                      self.gf('django.db.models.fields.CharField')(max_length=10, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'reports.leadsreport': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 26, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
