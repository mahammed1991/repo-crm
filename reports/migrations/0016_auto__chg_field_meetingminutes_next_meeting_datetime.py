...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeetingMinutes.next_meeting_datetime'
        db.alter_column(u'reports_meetingminutes', 'next_meeting_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'MeetingMinutes.next_meeting_datetime'
        db.alter_column(u'reports_meetingminutes', 'next_meeting_datetime', self.gf('django.db.models.fields.DateTimeField')(default=''))
