...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContectList.region'
        db.delete_column('contact_list', 'region_id')

        # Adding field 'ContectList.supporting_hours'
        db.add_column('contact_list', 'supporting_hours',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field target_location on 'ContectList'
        m2m_table_name = db.shorten_name('contact_list_target_location')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contectlist', models.ForeignKey(orm[u'main.contectlist'], null=False)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contectlist_id', 'location_id'])


    def backwards(self, orm):
        # Adding field 'ContectList.region'
        db.add_column('contact_list', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.Location'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ContectList.supporting_hours'
        db.delete_column('contact_list', 'supporting_hours')

        # Removing M2M table for field target_location on 'ContectList'
        db.delete_table(db.shorten_name('contact_list_target_location'))
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 11, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 11, 0, 0)'}),
