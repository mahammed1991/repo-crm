...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.second_resolved_by'
        db.add_column('feedback', 'second_resolved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='second_resolved_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Feedback.second_resolved_date'
        db.add_column('feedback', 'second_resolved_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Feedback.third_resolved_by'
        db.add_column('feedback', 'third_resolved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='third_resolved_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Feedback.third_resolved_date'
        db.add_column('feedback', 'third_resolved_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Feedback.resolved_count'
        db.add_column('feedback', 'resolved_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.second_resolved_by'
        db.delete_column('feedback', 'second_resolved_by_id')

        # Deleting field 'Feedback.second_resolved_date'
        db.delete_column('feedback', 'second_resolved_date')

        # Deleting field 'Feedback.third_resolved_by'
        db.delete_column('feedback', 'third_resolved_by_id')

        # Deleting field 'Feedback.third_resolved_date'
        db.delete_column('feedback', 'third_resolved_date')

        # Deleting field 'Feedback.resolved_count'
        db.delete_column('feedback', 'resolved_count')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 23, 0, 0)'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'main.feedback': {
            ...
            'resolved_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
