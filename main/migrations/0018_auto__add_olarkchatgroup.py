...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OlarkChatGroup'
        db.create_table('olark_chat_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operator_group', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150)),
            ('olark_script', self.gf('django.db.models.fields.TextField')()),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['OlarkChatGroup'])

        # Adding M2M table for field programs on 'OlarkChatGroup'
        m2m_table_name = db.shorten_name('olark_chat_group_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olarkchatgroup', models.ForeignKey(orm[u'main.olarkchatgroup'], null=False)),
            ('team', models.ForeignKey(orm[u'leads.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['olarkchatgroup_id', 'team_id'])

        # Adding M2M table for field target_location on 'OlarkChatGroup'
        m2m_table_name = db.shorten_name('olark_chat_group_target_location')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olarkchatgroup', models.ForeignKey(orm[u'main.olarkchatgroup'], null=False)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['olarkchatgroup_id', 'location_id'])

        # Adding M2M table for field google_rep on 'OlarkChatGroup'
        m2m_table_name = db.shorten_name('olark_chat_group_google_rep')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olarkchatgroup', models.ForeignKey(orm[u'main.olarkchatgroup'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['olarkchatgroup_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'OlarkChatGroup'
        db.delete_table('olark_chat_group')

        # Removing M2M table for field programs on 'OlarkChatGroup'
        db.delete_table(db.shorten_name('olark_chat_group_programs'))

        # Removing M2M table for field target_location on 'OlarkChatGroup'
        db.delete_table(db.shorten_name('olark_chat_group_target_location'))

        # Removing M2M table for field google_rep on 'OlarkChatGroup'
        db.delete_table(db.shorten_name('olark_chat_group_google_rep'))
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)'}),
