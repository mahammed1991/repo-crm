...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field region on 'Notification'
        m2m_table_name = db.shorten_name('notifications_region')
        ...
        db.create_unique(m2m_table_name, ['notification_id', 'region_id'])

        # Adding M2M table for field target_location on 'Notification'
        m2m_table_name = db.shorten_name('notifications_target_location')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notification', models.ForeignKey(orm[u'main.notification'], null=False)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['notification_id', 'location_id'])


    def backwards(self, orm):
        # Removing M2M table for field region on 'Notification'
        db.delete_table(db.shorten_name('notifications_region'))

        # Removing M2M table for field target_location on 'Notification'
        db.delete_table(db.shorten_name('notifications_target_location'))
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 27, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 27, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 27, 0, 0)'}),
