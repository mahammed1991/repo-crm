...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ResourceFAQ', fields ['task_type']
        db.delete_unique('resource_faq', ['task_type'])


    def backwards(self, orm):
        # Adding unique constraint on 'ResourceFAQ', fields ['task_type']
        db.create_unique('resource_faq', ['task_type'])
