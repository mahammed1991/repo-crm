...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.program'
        db.add_column('feedback', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.Team'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.program'
        db.delete_column('feedback', 'program_id')
