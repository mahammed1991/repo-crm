...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceFAQ'
        db.create_table('resource_faq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150)),
            ('task_question', self.gf('django.db.models.fields.TextField')()),
            ('submited_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['ResourceFAQ'])


    def backwards(self, orm):
        # Deleting model 'ResourceFAQ'
        db.delete_table('resource_faq')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 10, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 10, 0, 0)'}),
        ...
        u'main.resourcefaq': {
            ...
            'task_type': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '150'})
        },
        u'main.userdetails': {
