...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedback.lead_owner'
        db.alter_column('feedback', 'lead_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feedback.lead_owner'
        db.alter_column('feedback', 'lead_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.PortalUsers']))
