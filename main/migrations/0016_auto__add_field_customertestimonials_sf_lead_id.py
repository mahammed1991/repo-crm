...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerTestimonials.sf_lead_id'
        db.add_column('customer_testimonials', 'sf_lead_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerTestimonials.sf_lead_id'
        db.delete_column('customer_testimonials', 'sf_lead_id')
