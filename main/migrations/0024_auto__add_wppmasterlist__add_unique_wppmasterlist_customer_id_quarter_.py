...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WPPMasterList'
        db.create_table('wpp_master_list', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('provisional_assignee', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('server', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('framework', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('cms', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('ecommerce', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=4)),
            ('treatment_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.TreatmentType'], null=True, blank=True)),
        ...
        db.send_create_signal(u'main', ['WPPMasterList'])

        # Adding unique constraint on 'WPPMasterList', fields ['customer_id', 'quarter', 'year']
        db.create_unique('wpp_master_list', ['customer_id', 'quarter', 'year'])


    def backwards(self, orm):
        # Removing unique constraint on 'WPPMasterList', fields ['customer_id', 'quarter', 'year']
        db.delete_unique('wpp_master_list', ['customer_id', 'quarter', 'year'])

        # Deleting model 'WPPMasterList'
        db.delete_table('wpp_master_list')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 30, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 30, 0, 0)'}),
