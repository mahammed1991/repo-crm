...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContectList.is_active'
        db.add_column('contact_list', 'is_active',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContectList.is_active'
        db.delete_column('contact_list', 'is_active')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 9, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 9, 0, 0)'}),
