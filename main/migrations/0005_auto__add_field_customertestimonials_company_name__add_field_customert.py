...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerTestimonials.company_name'
        db.add_column('customer_testimonials', 'company_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerTestimonials.url'
        db.add_column('customer_testimonials', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserDetails.phone'
        db.add_column(u'main_userdetails', 'phone',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Adding field 'UserDetails.team'
        db.add_column(u'main_userdetails', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.Team'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserDetails.location'
        db.add_column(u'main_userdetails', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserDetails.profile_photo_url'
        db.add_column(u'main_userdetails', 'profile_photo_url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerTestimonials.company_name'
        db.delete_column('customer_testimonials', 'company_name')

        # Deleting field 'CustomerTestimonials.url'
        db.delete_column('customer_testimonials', 'url')

        # Deleting field 'UserDetails.phone'
        db.delete_column(u'main_userdetails', 'phone')

        # Deleting field 'UserDetails.team'
        db.delete_column(u'main_userdetails', 'team_id')

        # Deleting field 'UserDetails.location'
        db.delete_column(u'main_userdetails', 'location_id')

        # Deleting field 'UserDetails.profile_photo_url'
        db.delete_column(u'main_userdetails', 'profile_photo_url')
    ...
    models = {
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 8, 0, 0)'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
