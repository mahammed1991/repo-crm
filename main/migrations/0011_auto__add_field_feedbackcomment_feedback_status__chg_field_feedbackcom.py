...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackComment.feedback_status'
        db.add_column('feedback_comments', 'feedback_status',
                      self.gf('django.db.models.fields.CharField')(default='NEW', max_length=20),
                      keep_default=False)


        # Changing field 'FeedbackComment.comment'
        db.alter_column('feedback_comments', 'comment', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'FeedbackComment.feedback_status'
        db.delete_column('feedback_comments', 'feedback_status')


        # Changing field 'FeedbackComment.comment'
        db.alter_column('feedback_comments', 'comment', self.gf('django.db.models.fields.CharField')(max_length=1500))
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
