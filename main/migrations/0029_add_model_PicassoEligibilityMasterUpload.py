...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PicassoEligibilityMasterUpload'
        db.create_table('picasso_eligibilty_master_upload', (
            ...
            ('date_assess', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('assesment_type', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('pages', self.gf('django.db.models.fields.CharField')(default=1, max_length=100)),
            ('framework', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('mobile_responsivenes', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('buildeligible', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('development_time', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('priority_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=100)),
            ('highest_priority_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=100)),
            ('is_highest_priority', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('is_duplicate', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['PicassoEligibilityMasterUpload'])


    def backwards(self, orm):
        # Deleting model 'PicassoEligibilityMasterUpload'
        db.delete_table('picasso_eligibilty_master_upload')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 7, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 7, 0, 0)'}),
