...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PortalFeedback.bug_report_url'
        db.add_column('portal_feedback', 'bug_report_url',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PortalFeedback.bug_report_url'
        db.delete_column('portal_feedback', 'bug_report_url')
    ...
    models = {
        ...
        u'main.contectlist': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 31, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.customertestimonials': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 31, 0, 0)'}),
