...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContectList.created_date'
        db.add_column('contact_list', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 19, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ContectList.modified_date'
        db.add_column('contact_list', 'modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 19, 0, 0), auto_now=True, auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ContectList.created_date'
        db.delete_column('contact_list', 'created_date')

        # Deleting field 'ContectList.modified_date'
        db.delete_column('contact_list', 'modified_date')
    ...
    models = {
        ...
        u'leads.team': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
