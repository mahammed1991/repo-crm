...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.profile_image_url'
        db.add_column(u'forum_user', 'profile_image_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.profile_image_url'
        db.delete_column(u'forum_user', 'profile_image_url')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 0, 0)'}),
        ...
        'forum.user': {
            ...
            'profile_image_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 31, 0, 0)'}),
