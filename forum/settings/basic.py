...
APP_LOGO = Setting('APP_LOGO', '/static/images/logo.png', BASIC_SET, dict(
...
APP_TITLE = Setting('APP_TITLE', u'Google Portal: Google Portal Q&A Forum', BASIC_SET, dict(
label = _("Application title"),
help_text = _("The title of your application that will show in the browsers title bar")))

APP_SHORT_NAME = Setting(u'APP_SHORT_NAME', 'GP', BASIC_SET, dict(
label = _("Application short name"),
help_text = "The short name for your application that will show up in many places."))

APP_KEYWORDS = Setting('APP_KEYWORDS', u'Regalix,CNPROG,forum,community', BASIC_SET, dict(
...
APP_COPYRIGHT = Setting('APP_COPYRIGHT', u'Copyright Regalix, 2014. Some rights reserved under creative commons license.', BASIC_SET, dict(
