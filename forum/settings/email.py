...
EMAIL_HOST = Setting('EMAIL_HOST', 'smtp.gmail.com', EMAIL_SET, dict(
label = _("Email Server"),
help_text = _("The SMTP server through which your application will be sending emails."),
required=False))

EMAIL_PORT = Setting('EMAIL_PORT', 587, EMAIL_SET, dict(
label = _("Email Port"),
help_text = _("The port on which your SMTP server is listening to. Usually this is 25, but can be something else."),
required=False))

EMAIL_HOST_USER = Setting('EMAIL_HOST_USER', 'google@regalix-inc.com', EMAIL_SET, dict(
label = _("Email User"),
help_text = _("The username for your SMTP connection."),
required=False))

EMAIL_HOST_PASSWORD = Setting('EMAIL_HOST_PASSWORD', 'regalix123', EMAIL_SET, dict(
...
DEFAULT_FROM_EMAIL = Setting('DEFAULT_FROM_EMAIL', 'ram@regalix-inc.com', EMAIL_SET, dict(
...
DEFAULT_REPLY_TO_EMAIL = Setting('DEFAULT_REPLY_TO_EMAIL', 'no-reply@regalix-inc.com', EMAIL_SET, dict(
...
EMAIL_FOOTER_TEXT = Setting(u'EMAIL_FOOTER_TEXT', True, EMAIL_SET, dict(
