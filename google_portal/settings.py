...
SFDC_FIELDS = "Id, LastName, FirstName, Name, Company, Phone, Email, Description, Status, CreatedDate,\
    ...
    PICASSO_build_eligible__c, Picasso_Reference_Id__c, Picasso_TAT__c, Delivery_Date__c, IST_TIME_N__c, Corp_Email__c,\
    My_Advertiser_Email__c, My_Cases_Alias__c, Market_Selector__c, Language_Selector__c, Picasso_Type__c, ETO_LDAP__c"
