...
DEFAULT_LEAD_OWNER_EMAIL = 'tkhan@regalix-inc.com'
DEFAULT_LEAD_OWNER_ROLE = 'RSM'
DEFAULT_LEAD_OWNER_FNAME = 'Tabish'
DEFAULT_LEAD_OWNER_LNAME = 'Khan'
...
WPP_LEAD_STATUS = ['Open', 'On Hold', 'In Mockup', 'Mockup Review', 'Deferred', 'Mockup Delivered', 'In Development', 'In Stage', 'In A/B Test', 'Launched']
...
SFDC_FIELDS = "Id, LastName, FirstName, Name, Company, Phone, Email, Description, Status, CreatedDate,\
    ...
    Rescheduled_Appointments__c, Time_Zone__c, Lead_Sub_Status__c, Q2_Manager__c, WPP_Lead_Status__c, OwnerId"
