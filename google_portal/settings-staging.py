...
WPP_LEAD_STATUS = ['Open', 'On Hold', 'In UI/UX Review', 'In File Transfer', 'In Mockup', 'Mockup Review',
                   'In Development', 'In Stage', 'In A/B Test', 'Implemented', 'Deferred']
...
SFDC_FIELDS = "Id, LastName, FirstName, Name, Company, Phone, Email, Description, Status, CreatedDate,\
    ...
    Stage_URL_Credentials__c, AB_Testing__c, GCSS_Status__c, Language__c,  All_Regalix_Comments__c, Picasso_Objective__c, Internal_CID_1__c, POD_Name__c, Picasso_leads_status__c"
