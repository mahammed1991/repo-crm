...
SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_EMAILS = ['bshivamallappa@google.com', 'spenz@google.com', 'rwieker@google.com', 'sabinaa@google.com']
...
SFDC_FIELDS = "Id, LastName, FirstName, Name, Company, Phone, Email, Description, Status, CreatedDate,\
    ...
    Internal_CID_1__c, POD_Name__c, Picasso_Lead_Stage__c, PICASSO_build_eligible__c, Picasso_Reference_Id__c, Picasso_TAT__c, Delivery_Date__c"
