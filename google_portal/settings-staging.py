...
ALLOWED_HOSTS = ['10.250.2.21', '202.140.38.95', '54.161.28.110', 'gtrack.regalixdev.com', 'wpp.regalixdev.com',
...
MINICRM_URL = 'http://minicrm.regalixdev.com'
...
LEAD_STATUS_SUB_STATUS_MAPPING["ShoppingArgos"]["Attempting Contact"] = ["AC - Gate Keeper", "AC - Invalid Number",
                                                                         "AC - Left VM - Call Back",
                                                                         "AC - Phone rings but No Answer"]
LEAD_STATUS_SUB_STATUS_MAPPING["ShoppingArgos"]["In Progress"] = ["IP - Account Suspended", "IP - Advertiser at Work",
                                                                  "IP - Advertiser Unreachable",
                                                                  "IP - Awaiting Impressions", "IP - Campaign Paused",
                                                                  "IP - Data Quality Errors",
                                                                  "IP - Installing an Extension/Creating a Landing Page",
...
LEAD_STATUS_SUB_STATUS_MAPPING["ShoppingArgos"]["Pending QC - In Active"] = [
    ...
    "DL - Not Interested", "DL - Policy Issues", "DL - Redesigning Website", "DL - Technically unfeasible",
    "DL - Troubleshooting"]
LEAD_STATUS_SUB_STATUS_MAPPING["ShoppingArgos"]["Pending QC - WIN/Implemented"] = ["IM - WIN (Impressions Received)",
                                                                                   "IM - WIN > Troubleshooting (Complex)",
                                                                                   "IM - WIN - Troubleshooting(Basics)"]
...
PLA_SUB_STATUS = ["AC - Gate Keeper", "AC - Invalid Number", "AC - Left VM - Call Back",
                  ...
                  "DL - Account suspended when the lead was submitted.", "DL - Already Active", "DL - Campaign Paused",
                  "DL - Invalid contact Details", "DL - Lack of time/resources",
                  "DL - No access / No Website Credentials", "DL - No response", "DL - Not Interested",
                  "DL - Policy Issues", "DL - Redesigning Website", "DL - Technically unfeasible",
                  "DL - Troubleshooting", "IM - WIN (Impressions Received)", "IM - WIN > Troubleshooting (Complex)",
                  "IM - WIN - Troubleshooting(Basics)", "IP - Account Suspended", "IP - Advertiser at Work",
                  "IP - Advertiser Unreachable", "IP - Awaiting Impressions", "IP - Campaign Paused",
