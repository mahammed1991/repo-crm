...
function drawPieChart(details) {
    ...
    var pieChart_datatable = [
        ['Code Types', 'Leads per Code Type']
    ];
...
function drawLineChart(details) {
    ...
    var lineChart_datatable = [
        ['Weeks', 'Leads Won', 'Leads Submitted']
    ]
...
function customeTimeLineChartTable(details, s_keys, timeline) {
    ...
    var rows = '<tr><th class="lbl" style="background: #4D7DBE !important;">' + timeline + '</th><th class="lbl" style="background: #4D7DBE !important;">Leads Won</th><th class="lbl" style="background: #4D7DBE !important;">Leads Submitted</th><th class="lbl" style="background: #4D7DBE !important;">CR</th></tr>'
    var row = ''
...
function getPercentage(numerator, denaminator){
  if(denaminator && numerator){
    percentageValue = (((numerator/denaminator)*100).toFixed(2))
...
function customDrawLineChart(details, s_keys, timeline) {
    ...
    var lineChart_datatable = [
        [timeline, 'Leads Won', 'Leads Submitted']
    ]
...
function newTable(firstrow, details) {
    ...
    header = header + '<td>Total</td><td>CR</td></tr>'
    ...
    for (i = 0; i < details.length; i++) {
        ...
        percentageValue = getPercentage(value_dict['Implemented'],value_dict['Total'])
        percentageColumn = '<td>' + percentageValue + '</td>'
        each_row += dict_row + end + percentageColumn;
    }
