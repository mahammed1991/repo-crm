...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leads.appointment_date_in_pst'
        db.add_column(u'leads_leads', 'appointment_date_in_pst',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leads.rescheduled_appointment_in_pst'
        db.add_column(u'leads_leads', 'rescheduled_appointment_in_pst',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Leads.appointment_date_in_pst'
        db.delete_column(u'leads_leads', 'appointment_date_in_pst')

        # Deleting field 'Leads.rescheduled_appointment_in_pst'
        db.delete_column(u'leads_leads', 'rescheduled_appointment_in_pst')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 17, 0, 0)'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
