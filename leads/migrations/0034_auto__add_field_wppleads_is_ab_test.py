...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WPPLeads.is_ab_test'
        db.add_column(u'leads_wppleads', 'is_ab_test',
                      self.gf('django.db.models.fields.CharField')(default='YES', max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WPPLeads.is_ab_test'
        db.delete_column(u'leads_wppleads', 'is_ab_test')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 6, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 6, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
