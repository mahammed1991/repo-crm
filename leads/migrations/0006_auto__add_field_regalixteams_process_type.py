...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegalixTeams.process_type'
        db.add_column('regalix_teams', 'process_type',
                      self.gf('django.db.models.fields.CharField')(default='TAG', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegalixTeams.process_type'
        db.delete_column('regalix_teams', 'process_type')
    ...
    models = {
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
