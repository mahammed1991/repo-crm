...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArgosProcessTimeTracker.start_time'
        db.alter_column(u'leads_argosprocesstimetracker', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ArgosProcessTimeTracker.paused_on'
        db.alter_column(u'leads_argosprocesstimetracker', 'paused_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ArgosProcessTimeTracker.end_time'
        db.alter_column(u'leads_argosprocesstimetracker', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ArgosProcessTimeTracker.start_time'
        db.alter_column(u'leads_argosprocesstimetracker', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'ArgosProcessTimeTracker.paused_on'
        db.alter_column(u'leads_argosprocesstimetracker', 'paused_on', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'ArgosProcessTimeTracker.end_time'
        db.alter_column(u'leads_argosprocesstimetracker', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 5, 0, 0)'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
