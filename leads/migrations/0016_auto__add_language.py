...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'leads', ['Language'])

        # Adding M2M table for field language on 'Location'
        m2m_table_name = db.shorten_name('locations_language')
        ...
        db.create_unique(m2m_table_name, ['location_id', 'language_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field language on 'Location'
        db.delete_table(db.shorten_name('locations_language'))
    ...
    models = {
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
