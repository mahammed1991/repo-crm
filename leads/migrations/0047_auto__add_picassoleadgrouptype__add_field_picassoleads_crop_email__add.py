...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PicassoLeadGroupType'
        db.create_table(u'leads_picassoleadgrouptype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'leads', ['PicassoLeadGroupType'])

        # Adding field 'PicassoLeads.crop_email'
        db.add_column(u'leads_picassoleads', 'crop_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'PicassoLeads.my_advitiser_email'
        db.add_column(u'leads_picassoleads', 'my_advitiser_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PicassoLeads.my_cases_alias'
        db.add_column(u'leads_picassoleads', 'my_cases_alias',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PicassoLeads.market_selector'
        db.add_column(u'leads_picassoleads', 'market_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PicassoLeads.language_selector'
        db.add_column(u'leads_picassoleads', 'language_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PicassoLeads.picasso_type'
        db.add_column(u'leads_picassoleads', 'picasso_type',
                      self.gf('django.db.models.fields.CharField')(default='PICASSO', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Team.picasso_lead_group_type'
        db.add_column('teams', 'picasso_lead_group_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['leads.PicassoLeadGroupType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leads.eto_ldap'
        db.add_column(u'leads_leads', 'eto_ldap',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PicassoLeadGroupType'
        db.delete_table(u'leads_picassoleadgrouptype')

        # Deleting field 'PicassoLeads.crop_email'
        db.delete_column(u'leads_picassoleads', 'crop_email')

        # Deleting field 'PicassoLeads.my_advitiser_email'
        db.delete_column(u'leads_picassoleads', 'my_advitiser_email')

        # Deleting field 'PicassoLeads.my_cases_alias'
        db.delete_column(u'leads_picassoleads', 'my_cases_alias')

        # Deleting field 'PicassoLeads.market_selector'
        db.delete_column(u'leads_picassoleads', 'market_selector')

        # Deleting field 'PicassoLeads.language_selector'
        db.delete_column(u'leads_picassoleads', 'language_selector')

        # Deleting field 'PicassoLeads.picasso_type'
        db.delete_column(u'leads_picassoleads', 'picasso_type')

        # Deleting field 'Team.picasso_lead_group_type'
        db.delete_column('teams', 'picasso_lead_group_type_id')

        # Deleting field 'Leads.eto_ldap'
        db.delete_column(u'leads_leads', 'eto_ldap')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 28, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 28, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
