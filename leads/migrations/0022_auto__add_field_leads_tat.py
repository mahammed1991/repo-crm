...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leads.tat'
        db.add_column(u'leads_leads', 'tat',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Leads.tat'
        db.delete_column(u'leads_leads', 'tat')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 13, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 13, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
