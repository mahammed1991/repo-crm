...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TagLeadDetail.qc_exception'
        db.add_column(u'leads_tagleaddetail', 'qc_exception',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TagLeadDetail.qc_exception'
        db.delete_column(u'leads_tagleaddetail', 'qc_exception')
