...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leads.rescheduled_appointment_in_ist'
        db.add_column(u'leads_leads', 'rescheduled_appointment_in_ist',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Leads.rescheduled_appointment_in_ist'
        db.delete_column(u'leads_leads', 'rescheduled_appointment_in_ist')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
