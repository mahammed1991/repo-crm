...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArgosProcessTimeTracker.rep_name'
        # db.delete_column(u'leads_argosprocesstimetracker', 'rep_name')

        # Adding field 'ArgosProcessTimeTracker.assignee'
        db.add_column(u'leads_argosprocesstimetracker', 'assignee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assignee', null=False,
                                                                            to=orm['auth.User']), keep_default=False)

        # Adding field 'ArgosProcessTimeTracker.status'
        db.add_column(u'leads_argosprocesstimetracker', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Start', max_length=10),
                      keep_default=False)

        # Adding field 'ArgosProcessTimeTracker.assigner'
        db.add_column(u'leads_argosprocesstimetracker', 'assigner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigner', null=False,
                                                                            to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArgosProcessTimeTracker.rep_name'
        '''db.add_column(u'leads_argosprocesstimetracker', 'rep_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)'''

        # Deleting field 'ArgosProcessTimeTracker.assignee'
        db.delete_column(u'leads_argosprocesstimetracker', 'assignee_id')

        # Deleting field 'ArgosProcessTimeTracker.status'
        db.delete_column(u'leads_argosprocesstimetracker', 'status')

        # Deleting field 'ArgosProcessTimeTracker.assigner'
        db.delete_column(u'leads_argosprocesstimetracker', 'assigner_id')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 12, 0, 0)'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 12, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
