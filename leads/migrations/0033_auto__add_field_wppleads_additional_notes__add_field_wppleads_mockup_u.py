...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WPPLeads.additional_notes'
        db.add_column(u'leads_wppleads', 'additional_notes',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'WPPLeads.mockup_url'
        db.add_column(u'leads_wppleads', 'mockup_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'WPPLeads.mockup_password'
        db.add_column(u'leads_wppleads', 'mockup_password',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'WPPLeads.stage_url'
        db.add_column(u'leads_wppleads', 'stage_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'WPPLeads.stage_password'
        db.add_column(u'leads_wppleads', 'stage_password',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WPPLeads.additional_notes'
        db.delete_column(u'leads_wppleads', 'additional_notes')

        # Deleting field 'WPPLeads.mockup_url'
        db.delete_column(u'leads_wppleads', 'mockup_url')

        # Deleting field 'WPPLeads.mockup_password'
        db.delete_column(u'leads_wppleads', 'mockup_password')

        # Deleting field 'WPPLeads.stage_url'
        db.delete_column(u'leads_wppleads', 'stage_url')

        # Deleting field 'WPPLeads.stage_password'
        db.delete_column(u'leads_wppleads', 'stage_password')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 31, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 31, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
