...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TagLeadDetail.campaign_created_by_gsr'
        db.alter_column(u'leads_tagleaddetail', 'campaign_created_by_gsr', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'TagLeadDetail.mouse_control_taken'
        db.alter_column(u'leads_tagleaddetail', 'mouse_control_taken', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'TagLeadDetail.live_transfer'
        db.alter_column(u'leads_tagleaddetail', 'live_transfer', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TagLeadDetail.campaign_created_by_gsr'
        db.alter_column(u'leads_tagleaddetail', 'campaign_created_by_gsr', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TagLeadDetail.mouse_control_taken'
        db.alter_column(u'leads_tagleaddetail', 'mouse_control_taken', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'TagLeadDetail.live_transfer'
        db.alter_column(u'leads_tagleaddetail', 'live_transfer', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 16, 0, 0)'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 11, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
