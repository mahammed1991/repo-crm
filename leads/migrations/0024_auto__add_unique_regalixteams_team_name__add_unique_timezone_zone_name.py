...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field program on 'RegalixTeams'
        m2m_table_name = db.shorten_name('regalix_teams_program')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('regalixteams', models.ForeignKey(orm[u'leads.regalixteams'], null=False)),
            ('team', models.ForeignKey(orm[u'leads.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['regalixteams_id', 'team_id'])

        # Adding M2M table for field ldap on 'RegalixTeams'
        m2m_table_name = db.shorten_name('regalix_teams_ldap')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('regalixteams', models.ForeignKey(orm[u'leads.regalixteams'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['regalixteams_id', 'user_id'])

        # Adding M2M table for field team_lead on 'RegalixTeams'
        m2m_table_name = db.shorten_name('regalix_teams_team_lead')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('regalixteams', models.ForeignKey(orm[u'leads.regalixteams'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ...
        # Adding M2M table for field team_manager on 'RegalixTeams'
        m2m_table_name = db.shorten_name('regalix_teams_team_manager')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('regalixteams', models.ForeignKey(orm[u'leads.regalixteams'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ...
        # Adding unique constraint on 'RegalixTeams', fields ['team_name']
        db.create_unique('regalix_teams', ['team_name'])

        # Adding unique constraint on 'Timezone', fields ['zone_name']
        db.create_unique('timezone', ['zone_name'])

        # Adding field 'Location.daylight_start'
        db.add_column('locations', 'daylight_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.daylight_end'
        db.add_column('locations', 'daylight_end',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field ds_time_zone on 'Location'
        m2m_table_name = db.shorten_name('locations_ds_time_zone')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False)),
            ('timezone', models.ForeignKey(orm[u'leads.timezone'], null=False))
        ))
        db.create_unique(m2m_table_name, ['location_id', 'timezone_id'])

        # Adding unique constraint on 'Location', fields ['location_name']
        db.create_unique('locations', ['location_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Location', fields ['location_name']
        db.delete_unique('locations', ['location_name'])

        # Removing unique constraint on 'Timezone', fields ['zone_name']
        db.delete_unique('timezone', ['zone_name'])

        # Removing unique constraint on 'RegalixTeams', fields ['team_name']
        db.delete_unique('regalix_teams', ['team_name'])

        # Removing M2M table for field program on 'RegalixTeams'
        db.delete_table(db.shorten_name('regalix_teams_program'))

        # Removing M2M table for field ldap on 'RegalixTeams'
        db.delete_table(db.shorten_name('regalix_teams_ldap'))

        # Removing M2M table for field team_lead on 'RegalixTeams'
        db.delete_table(db.shorten_name('regalix_teams_team_lead'))

        # Removing M2M table for field team_manager on 'RegalixTeams'
        db.delete_table(db.shorten_name('regalix_teams_team_manager'))

        # Deleting field 'Location.daylight_start'
        db.delete_column('locations', 'daylight_start')

        # Deleting field 'Location.daylight_end'
        db.delete_column('locations', 'daylight_end')

        # Removing M2M table for field ds_time_zone on 'Location'
        db.delete_table(db.shorten_name('locations_ds_time_zone'))
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
