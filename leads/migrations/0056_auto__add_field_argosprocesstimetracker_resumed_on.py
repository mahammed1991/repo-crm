...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArgosProcessTimeTracker.resumed_on'
        db.add_column(u'leads_argosprocesstimetracker', 'resumed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArgosProcessTimeTracker.resumed_on'
        db.delete_column(u'leads_argosprocesstimetracker', 'resumed_on')
