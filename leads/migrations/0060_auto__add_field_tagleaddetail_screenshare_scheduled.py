...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TagLeadDetail.screenshare_scheduled'
        db.add_column(u'leads_tagleaddetail', 'screenshare_scheduled',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TagLeadDetail.screenshare_scheduled'
        db.delete_column(u'leads_tagleaddetail', 'screenshare_scheduled')
