...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WPPLeads.is_build_eligible'
        db.add_column(u'leads_wppleads', 'is_build_eligible',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WPPLeads.is_build_eligible'
        db.delete_column(u'leads_wppleads', 'is_build_eligible')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 8, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 8, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
