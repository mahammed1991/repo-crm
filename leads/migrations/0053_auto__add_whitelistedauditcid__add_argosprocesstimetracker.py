...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'leads_whitelistedauditcid', (
            ...
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 10, 4, 0, 0))),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 10, 4, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['WhiteListedAuditCID'])

        #Adding model 'ArgosProcessTimeTracker'
        db.create_table(u'leads_argosprocesstimetracker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leads.Leads'])),
            ('rep_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('products_count', self.gf('django.db.models.fields.IntegerField')()),
            ('attributes', self.gf('django.db.models.fields.TextField')(default='')),
            ('start_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('paused_on', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('time_spent', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['ArgosProcessTimeTracker'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ArgosProcessTimeTracker'
        db.delete_table(u'leads_argosprocesstimetracker')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 4, 0, 0)'}),
        ...
        u'leads.argosprocesstimetracker': {
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'paused_on': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            'products_count': ('django.db.models.fields.IntegerField', [], {}),
            'rep_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 10, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
