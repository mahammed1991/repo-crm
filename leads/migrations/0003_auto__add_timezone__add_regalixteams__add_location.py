...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timezone', (
            ...
            ('zone_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('time_value', self.gf('django.db.models.fields.CharField')(max_length=6)),
        ))
        db.send_create_signal(u'leads', ['Timezone'])

        # Adding model 'RegalixTeams'
        db.create_table('regalix_teams', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'leads', ['RegalixTeams'])

        # Adding M2M table for field location on 'RegalixTeams'
        m2m_table_name = db.shorten_name('regalix_teams_location')
        ...
        db.create_unique(m2m_table_name, ['regalixteams_id', 'location_id'])
        ...
        db.send_create_signal(u'leads', ['Location'])

        # Adding M2M table for field time_zone on 'Location'
        m2m_table_name = db.shorten_name('locations_time_zone')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('timezone')

        # Deleting model 'RegalixTeams'
        db.delete_table('regalix_teams')

        # Removing M2M table for field location on 'RegalixTeams'
        db.delete_table(db.shorten_name('regalix_teams_location'))

        # Deleting model 'Location'
        db.delete_table('locations')

        # Removing M2M table for field time_zone on 'Location'
        db.delete_table(db.shorten_name('locations_time_zone'))
