...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PicassoLeads.internal_cid'
        db.alter_column(u'leads_picassoleads', 'internal_cid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'PicassoLeads.internal_cid'
        db.alter_column(u'leads_picassoleads', 'internal_cid', self.gf('django.db.models.fields.CharField')(default=' ', max_length=50))
