...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PicassoLeads.picasso_objective'
        db.alter_column(u'leads_picassoleads', 'picasso_objective', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Leads.appointment_date_in_ist'
        db.add_column(u'leads_leads', 'appointment_date_in_ist',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PicassoLeads.picasso_objective'
        db.alter_column(u'leads_picassoleads', 'picasso_objective', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Deleting field 'Leads.appointment_date_in_ist'
        db.delete_column(u'leads_leads', 'appointment_date_in_ist')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
