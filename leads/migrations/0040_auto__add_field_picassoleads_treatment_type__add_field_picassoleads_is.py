...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PicassoLeads.treatment_type'
        db.add_column(u'leads_picassoleads', 'treatment_type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PicassoLeads.is_build_eligible'
        db.add_column(u'leads_picassoleads', 'is_build_eligible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PicassoLeads.treatment_type'
        db.delete_column(u'leads_picassoleads', 'treatment_type')

        # Deleting field 'PicassoLeads.is_build_eligible'
        db.delete_column(u'leads_picassoleads', 'is_build_eligible')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 8, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 8, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
