...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('treatment_type', (
        ...
        db.send_create_signal(u'leads', ['TreatmentType'])


    def backwards(self, orm):
        # Deleting model 'TreatmentType'
        db.delete_table('treatment_type')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'wpp_treatment_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        u'leads.location': {
