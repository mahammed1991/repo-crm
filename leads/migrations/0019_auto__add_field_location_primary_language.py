...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.primary_language'
        db.add_column('locations', 'primary_language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='primary_language', to=orm['leads.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.primary_language'
        db.delete_column('locations', 'primary_language_id')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 19, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 19, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
