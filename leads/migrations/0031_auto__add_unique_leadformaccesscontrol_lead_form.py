...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LeadFormAccessControl', fields ['lead_form']
        db.create_unique('lead_form_controls', ['lead_form_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LeadFormAccessControl', fields ['lead_form']
        db.delete_unique('lead_form_controls', ['lead_form_id'])
