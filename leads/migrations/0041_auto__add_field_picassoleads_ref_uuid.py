...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PicassoLeads.ref_uuid'
        db.add_column(u'leads_picassoleads', 'ref_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PicassoLeads.ref_uuid'
        db.delete_column(u'leads_picassoleads', 'ref_uuid')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 16, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 16, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
