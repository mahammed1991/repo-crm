...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CodeType.avg_setup_time'
        db.add_column('code_types', 'avg_setup_time',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CodeType.avg_setup_time'
        db.delete_column('code_types', 'avg_setup_time')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 3, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
