...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WPPLeads.is_nominated'
        db.add_column(u'leads_wppleads', 'is_nominated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WPPLeads.is_nominated'
        db.delete_column(u'leads_wppleads', 'is_nominated')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 28, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 28, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
