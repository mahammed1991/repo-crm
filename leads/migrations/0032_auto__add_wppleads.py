...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WPPLeads'
        db.create_table(u'leads_wppleads', (
            ...
            ('first_contacted_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('rescheduled_appointment', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('rescheduled_appointment_in_ist', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dials', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 27, 0, 0))),
            ('updated_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 7, 27, 0, 0), auto_now=True, blank=True)),
            ('sf_lead_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('treatment_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['WPPLeads'])


    def backwards(self, orm):
        # Deleting model 'WPPLeads'
        db.delete_table(u'leads_wppleads')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 27, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
