...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('locations', 'phone',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Location.flag_image'
        db.add_column('locations', 'flag_image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('locations', 'phone')

        # Deleting field 'Location.flag_image'
        db.delete_column('locations', 'flag_image')
    ...
    models = {
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 9, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
