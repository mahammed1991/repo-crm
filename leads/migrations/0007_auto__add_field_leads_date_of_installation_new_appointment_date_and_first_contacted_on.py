...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leads.date_of_installation_new'
        db.add_column(u'leads_leads', 'date_of_installation_new',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leads.appointment_date'
        db.add_column(u'leads_leads', 'appointment_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leads.first_contacted_on'
        db.add_column(u'leads_leads', 'first_contacted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Leads.date_of_installation_new'
        db.delete_column(u'leads_leads', 'date_of_installation_new')

        # Deleting field 'Leads.appointment_date'
        db.delete_column(u'leads_leads', 'appointment_date')

        # Deleting field 'Leads.first_contacted_on'
        db.delete_column(u'leads_leads', 'first_contacted_on')
