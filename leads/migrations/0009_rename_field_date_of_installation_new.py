...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Leads.date_of_installation_new'
        db.delete_column(u'leads_leads', 'date_of_installation')

        db.rename_column(u'leads_leads', 'date_of_installation_new', 'date_of_installation')

    def backwards(self, orm):
        # Renaming field 'Leads.date_of_installation'
        db.rename_column(u'leads_leads', 'date_of_installation', 'date_of_installation_new')

        db.add_column(u'leads_leads', 'date_of_installation',
