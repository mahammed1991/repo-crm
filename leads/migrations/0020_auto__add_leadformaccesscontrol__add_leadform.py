...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadFormAccessControl'
        db.create_table('lead_form_controls', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lead_form', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leads.LeadForm'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['LeadFormAccessControl'])

        # Adding M2M table for field programs on 'LeadFormAccessControl'
        m2m_table_name = db.shorten_name('lead_form_controls_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('leadformaccesscontrol', models.ForeignKey(orm[u'leads.leadformaccesscontrol'], null=False)),
            ('team', models.ForeignKey(orm[u'leads.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['leadformaccesscontrol_id', 'team_id'])

        # Adding M2M table for field target_location on 'LeadFormAccessControl'
        m2m_table_name = db.shorten_name('lead_form_controls_target_location')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('leadformaccesscontrol', models.ForeignKey(orm[u'leads.leadformaccesscontrol'], null=False)),
            ('location', models.ForeignKey(orm[u'leads.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['leadformaccesscontrol_id', 'location_id'])

        # Adding model 'LeadForm'
        db.create_table('lead_forms', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'leads', ['LeadForm'])


    def backwards(self, orm):
        # Deleting model 'LeadFormAccessControl'
        db.delete_table('lead_form_controls')

        # Removing M2M table for field programs on 'LeadFormAccessControl'
        db.delete_table(db.shorten_name('lead_form_controls_programs'))

        # Removing M2M table for field target_location on 'LeadFormAccessControl'
        db.delete_table(db.shorten_name('lead_form_controls_target_location'))

        # Deleting model 'LeadForm'
        db.delete_table('lead_forms')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)'}),
        ...
        u'leads.leadformaccesscontrol': {
            ...
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'programs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['leads.Team']", 'symmetrical': 'False'}),
            'target_location': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['leads.Location']", 'symmetrical': 'False'})
        },
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
