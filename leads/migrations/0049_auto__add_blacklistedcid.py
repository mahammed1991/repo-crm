...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlackListedCID'
        db.create_table(u'leads_blacklistedcid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='modified_by_user', to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 7, 21, 0, 0))),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 7, 21, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['BlackListedCID'])


    def backwards(self, orm):
        # Deleting model 'BlackListedCID'
        db.delete_table(u'leads_blacklistedcid')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)'}),
        ...
        u'leads.blacklistedcid': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'modified_by_user'", 'to': u"orm['auth.User']"}),
            'modified_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        u'leads.chatmessage': {
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
