...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field google_rep on 'LeadFormAccessControl'
        m2m_table_name = db.shorten_name('lead_form_controls_google_rep')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('leadformaccesscontrol', models.ForeignKey(orm[u'leads.leadformaccesscontrol'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['leadformaccesscontrol_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field google_rep on 'LeadFormAccessControl'
        db.delete_table(db.shorten_name('lead_form_controls_google_rep'))
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
