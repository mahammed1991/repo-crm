...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SfdcUsers'
        db.create_table('sfdc_users', (
        ...
        db.send_create_signal(u'leads', ['SfdcUsers'])


    def backwards(self, orm):
        # Deleting model 'SfdcUsers'
        db.delete_table('sfdc_users')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
