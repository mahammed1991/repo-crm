...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimezoneMapping'
        db.create_table('timezone_mapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('standard_timezone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='std_timezone', unique=True, to=orm['leads.Timezone'])),
            ('daylight_timezone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ds_timezone', unique=True, to=orm['leads.Timezone'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'leads', ['TimezoneMapping'])

        # Adding unique constraint on 'TimezoneMapping', fields ['standard_timezone', 'daylight_timezone']
        db.create_unique('timezone_mapping', ['standard_timezone_id', 'daylight_timezone_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TimezoneMapping', fields ['standard_timezone', 'daylight_timezone']
        db.delete_unique('timezone_mapping', ['standard_timezone_id', 'daylight_timezone_id'])

        # Deleting model 'TimezoneMapping'
        db.delete_table('timezone_mapping')
