...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PicassoLeads.estimated_tat'
        db.add_column(u'leads_picassoleads', 'estimated_tat',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PicassoLeads.estimated_tat'
        db.delete_column(u'leads_picassoleads', 'estimated_tat')
    ...
    models = {
        ...
        u'leads.agencydetails': {
            ...
            'appointment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 19, 0, 0)'}),
        ...
        u'leads.leads': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 19, 0, 0)'}),
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
