...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Leads.created_by'
        db.add_column(u'leads_leads', 'created_by',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Leads.last_updated_by'
        db.add_column(u'leads_leads', 'last_updated_by',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Leads.created_by'
        db.delete_column(u'leads_leads', 'created_by')

        # Deleting field 'Leads.last_updated_by'
        db.delete_column(u'leads_leads', 'last_updated_by')
