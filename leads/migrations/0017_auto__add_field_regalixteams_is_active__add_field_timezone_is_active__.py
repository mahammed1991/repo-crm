...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegalixTeams.is_active'
        db.add_column('regalix_teams', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Timezone.is_active'
        db.add_column('timezone', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Location.is_active'
        db.add_column('locations', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Team.is_active'
        db.add_column('teams', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegalixTeams.is_active'
        db.delete_column('regalix_teams', 'is_active')

        # Deleting field 'Timezone.is_active'
        db.delete_column('timezone', 'is_active')

        # Deleting field 'Location.is_active'
        db.delete_column('locations', 'is_active')

        # Deleting field 'Team.is_active'
        db.delete_column('teams', 'is_active')
    ...
    models = {
        ...
        u'leads.leads': {
            ...
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
