...
class TagLeadDetail(models.Model):
    ...
    spend_cfc = models.CharField(max_length=100, blank=True, null=True, default='')
    reason_for_conversion_not_reporting = models.CharField(max_length=100, blank=True, null=True, default='')
    unethical_win = models.BooleanField(default=False)
    ...
    other_cms = models.CharField(max_length=100, blank=True, null=True, default='')
    gcss_exception_approved_by = models.CharField(max_length=100, blank=True, null=True, default='')
    action_taken = models.CharField(max_length=100, blank=True, null=True, default='')
    ...
    on_call_win = models.DateTimeField(blank=True, null=True)
    dynamic_value = models.CharField(max_length=80, blank=True, null=True, default='')
    regalix_webmaster = models.CharField(max_length=150, blank=True, null=True, default='')
    anything_else_we_should_know = models.TextField(blank=True, null=True)
    not_interested_cases_rca = models.CharField(max_length=80, blank=True, null=True, default='')
    lead_bundle = models.CharField(max_length=100, blank=True, null=True, default='')
    alternate_contact_role = models.CharField(max_length=100, blank=True, null=True, default='')
    contact_alternate = models.BooleanField(default=False)
    qc_exception = models.DateTimeField(blank=True, null=True)
    please_specify_if_others = models.CharField(max_length=100, blank=True, null=True, default='')
    reporting_status_1 = models.CharField(max_length=100, blank=True, null=True, default='')
    reporting_status_2 = models.CharField(max_length=100, blank=True, null=True, default='')
    reporting_status_3 = models.CharField(max_length=100, blank=True, null=True, default='')
    reporting_status_4 = models.CharField(max_length=100, blank=True, null=True, default='')
    reporting_status_5 = models.CharField(max_length=100, blank=True, null=True, default='')
    analytics_account_id_1 = models.CharField(max_length=100, blank=True, null=True, default='')
    analytics_account_id_2 = models.CharField(max_length=100, blank=True, null=True, default='')
    analytics_account_id_3 = models.CharField(max_length=100, blank=True, null=True, default='')
    analytics_account_id_4 = models.CharField(max_length=100, blank=True, null=True, default='')
    analytics_account_id_5 = models.CharField(max_length=100, blank=True, null=True, default='')
    transaction_behaviour_1 = models.BooleanField(default=False)
    transaction_behaviour_2 = models.BooleanField(default=False)
    transaction_behaviour_3 = models.BooleanField(default=False)
    transaction_behaviour_4 = models.BooleanField(default=False)
    transaction_behaviour_5 = models.BooleanField(default=False)
    check_out_process_1 = models.BooleanField(default=False)
    check_out_process_2 = models.BooleanField(default=False)
    check_out_process_3 = models.BooleanField(default=False)
    check_out_process_4 = models.BooleanField(default=False)
    check_out_process_5 = models.BooleanField(default=False)
    cart_page_behaviour_1 = models.BooleanField(default=False)
    cart_page_behaviour_2 = models.BooleanField(default=False)
    cart_page_behaviour_3 = models.BooleanField(default=False)
    cart_page_behaviour_4 = models.BooleanField(default=False)
    cart_page_behaviour_5 = models.BooleanField(default=False)
    created_call_extension_1 = models.BooleanField(default=False)
    created_call_extension_2 = models.BooleanField(default=False)
    created_call_extension_3 = models.BooleanField(default=False)
    created_call_extension_4 = models.BooleanField(default=False)
    created_call_extension_5 = models.BooleanField(default=False)
    analytics_code_is_setup_1 = models.BooleanField(default=False)
    analytics_code_is_setup_2 = models.BooleanField(default=False)
    analytics_code_is_setup_3 = models.BooleanField(default=False)
    analytics_code_is_setup_4 = models.BooleanField(default=False)
    analytics_code_is_setup_5 = models.BooleanField(default=False)
    product_behaviour_1 = models.BooleanField(default=False)
    product_behaviour_2 = models.BooleanField(default=False)
    product_behaviour_3 = models.BooleanField(default=False)
    product_behaviour_4 = models.BooleanField(default=False)
    product_behaviour_5 = models.BooleanField(default=False)
