...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailabilityForTAT.audits_per_date'
        db.add_column('availability_for_tat', 'audits_per_date',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailabilityForTAT.audits_per_date'
        db.delete_column('availability_for_tat', 'audits_per_date')
