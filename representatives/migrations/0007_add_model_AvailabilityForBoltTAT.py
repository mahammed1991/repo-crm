...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AvailabilityForBoltTAT'
        db.create_table('availability_for_bolt_tat', (
            ...
            ('audits_per_date', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'representatives', ['AvailabilityForBoltTAT'])


    def backwards(self, orm):
        # Deleting model 'AvailabilityForBoltTAT'
        db.delete_table('availability_for_bolt_tat')
    ...
    models = {
        ...
        u'representatives.availabilityforbolttat': {
            'Meta': {'object_name': 'AvailabilityForBoltTAT', 'db_table': "'availability_for_bolt_tat'"},
            'audits_per_date': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'representatives.googerepresentatives': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 30, 0, 0)'}),
