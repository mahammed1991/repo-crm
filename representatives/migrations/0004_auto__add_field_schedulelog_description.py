...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduleLog.description'
        db.add_column('schedule_log', 'description',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduleLog.description'
        db.delete_column('schedule_log', 'description')
    ...
    models = {
        ...
        u'representatives.googerepresentatives': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)'}),
