...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Availability.team'
        db.add_column('availability', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['leads.RegalixTeams']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Availability.team'
        db.delete_column('availability', 'team_id')
